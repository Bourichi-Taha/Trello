...
const CardForm = forwardRef<HTMLTextAreaElement,CardFormProps>((props,ref) => {

    const {disableEditing,enableEditing,isEditing,listId} = props;
    ...
    if (isEditing) {
        return (
            <form ref={formRef} action={onSubmit} className="m-1 py-0.5 px-1 space-y-4" >
                <FormTextarea  disabled={isLoading} ref={ref} id="title" onKeyDown={onTextAreaKeyDown} placeholder="Enter a title for this card..." errors={fieldErrors}  />
